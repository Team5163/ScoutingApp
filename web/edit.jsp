    ...
    <body>
        ...
        <section id="teamlist">
            <form id="teamlistform">
                <input id="search" type="text" name="teamNumber" placeholder="Search Teams" oninput="setTeamList(URLTeamList)"/></form>
        ...
        <footer>
            <ul><li><a href="about.jsp">About</a></li>
                ...
                <li><a href="login.jsp">Log In or Sign Up to edit team information.</a></li>
                    <%} else {%>
