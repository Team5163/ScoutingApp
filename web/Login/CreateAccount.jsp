    ...
    <body>
        <div>
            <form method="POST" action="${pageContext.request.contextPath}/Create">
                ...
                Team Number: <input type="text" placeholder="Team Number" name="teamnum" class="input"/><br />
                Admin Password: <input type="password" placeholder="Please get your admin to type password here" name="adminPass" class="input" /><br />
